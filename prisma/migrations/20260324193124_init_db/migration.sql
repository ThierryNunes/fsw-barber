...
-- AddForeignKey
ALTER TABLE `BarbershopPhone` ADD CONSTRAINT `BarbershopPhone_barbershopId_fkey` FOREIGN KEY (`barbershopId`) REFERENCES `Barbershop`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
